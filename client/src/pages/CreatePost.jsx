    ...
    <div className=" flex bg-black ">
      ...
      <div className="relative w-full h-screen flex justify-center items-center text-white bg-black smlg:w-[90%] smlg:ml-[10%] lap:w-[82%] lap:ml-[18%]">
        ...
        <div className="relative  bg-[#19191A] rounded-md justify-center w-[350px] h-[500px] smlg:w-[600px] items-center mt-3 z-10">
          <h2 className="text-white text-center mt-1 mb-1 pb-1 border-b border-[#2e2e2f]">
            Create Post
          </h2>
          <div className="flex flex-col justify-center items-center h-[80%] mt-6">
            {filePreview ? (
              <>
                <img className="w-full h-[70%] " src={filePreview} />
                {!ImageUploadDone && (
                  <button
                    className="w-[130px] bg-[#0095F6]  text-white h-[30px] mt-2 rounded-md flex justify-center items-center "
                ...
                {ImageUploadDone && (
                  <div className="w-full mt-2">
                    <textarea
                      ...
                      className="w-full bg-transparent outline-none p-3 resize-none"
                      rows={3}
                      onChange={handleFormdata}
                    ></textarea>

                    <button
                      className="w-[100px] bg-[#0095F6] flex justify-center items-center text-white h-[30px] mt-2 rounded-md ml-2 "
                      onClick={createPost}
                    >
                      {postuploading ? (
                        <svg
              ...
              <>
                ...
                <button
                  ...
                  className="w-[130px] bg-[#0095F6] text-white h-[30px] rounded-md mt-5"
                >
                  Select Photo
                </button>
              </>

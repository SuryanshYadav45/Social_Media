    ...
    <div className=" flex bg-black ">
      ...
      <div className="relative w-full h-screen flex justify-center items-center text-white bg-black smlg:w-[90%] smlg:ml-[10%] lap:w-[82%] lap:ml-[18%]">
        ...
        <RiCloseLargeFill
          size={30}
          onClick={() => navigate(-1)}
          className="text-white absolute top-8 cursor-pointer right-10"
        />
        <div className="relative  bg-[#19191A]  flex w-[80%] h-[80vh] items-center mt-3 z-10 border border-[#282626]">
          ...
          <div className="flex-[2]  h-full">
            ...
            <div className="border-t border-[#282626] p-2">
              <div className="flex ">
              {

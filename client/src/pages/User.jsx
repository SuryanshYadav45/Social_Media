  ...
  return (
    <div className="flex relative bg-black ">
      ...
      {IsLoading ? (
        ...
        <div className="  w-full min-h-screen mb-10 smlg:mb-0  text-white bg-black smlg:w-[90%] smlg:ml-[10%] lap:w-[90%] lap:ml-[15%] ">
          <div className="flex w-full justify-center mt-6 ">
            ...
            <div className="flex flex-col">
              <div className="mb-3 flex justify-between smlg:w-[330px]">
                <span className="text-[20px] smlg:text-[25px]">
                  {userData?.username}
                </span>

                {userData._id === decodeUser.id ? (
                  <button
                    className="bg-[#363636] rounded-md ml-2 text-[13px] smlg:text-[17px] mt-[1px] text-white w-[90px] h-[30px] smlg:w-[120px] smlg:h-[35px] "
              ...
              {decodeUser.id === id && (
                <button
                  onClick={logout}
                  className="bg-[#363636] w-[130px] rounded-lg h-[30px] mt-3 text-white"
                >
                  Logout
                </button>
              )}
          ...
          {userPost.length <= 0 ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 p-4  w-[80%] mx-auto place-items-center">
              {userPost.map((post) => (
                <img
                  key={post._id}
                  className="hover:opacity-75 w-[250px] h-[250px] smlg:h-[350px] smlg:w-[266px]"
      ...
      {updateProfile && (
        <div className="absolute flex justify-center items-center  backdrop-blur-[6px] bg-transparent w-full h-screen">
          <div className="w-[80%] relative bg-black p-6 flex flex-col   rounded-2xl shadow-sm shadow-gray-500">
            ...
            />
            <h3 className="text-white text-center mb-4 text-[23px]">
              Updated Profile
            </h3>
            ...
            <button
              ...
              className="bg-[#0095F6] w-auto p-5 flex justify-center
                    items-center h-[35px] text-white mx-auto mt-3 rounded"
